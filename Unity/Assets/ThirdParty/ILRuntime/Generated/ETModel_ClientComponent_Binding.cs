...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_ClientComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_LocalPlayer_1);
            args = new Type[]{typeof(ETModel.User)};
            method = type.GetMethod("set_LocalPlayer", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_LocalPlayer_2);
        ...
        static StackObject* get_LocalPlayer_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* set_LocalPlayer_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
