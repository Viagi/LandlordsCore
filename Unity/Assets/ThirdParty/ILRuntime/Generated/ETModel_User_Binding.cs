...
{
    unsafe class ETModel_User_Binding
    {
        ...
        static StackObject* get_UserID_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.User instance_of_this_method;
            instance_of_this_method = (ETModel.User)typeof(ETModel.User).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
