...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Collections_Generic_List_1_Card_Binding
    {
        ...
        static StackObject* get_Count_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.List<ETModel.Card> instance_of_this_method = (System.Collections.Generic.List<ETModel.Card>)typeof(System.Collections.Generic.List<ETModel.Card>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
