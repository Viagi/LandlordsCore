...
namespace Model
{
	...
	[ProtoInclude(Opcode.Actor_Test, typeof(Actor_Test))]
	[ProtoInclude(Opcode.Actor_CreateUnits, typeof(Actor_CreateUnits))]
	[ProtoInclude(Opcode.FrameMessage, typeof(FrameMessage))]
	...
	[ProtoInclude(Opcode.Actor_TestRequest, typeof(Actor_TestRequest))]
	[ProtoInclude(Opcode.Actor_TransferRequest, typeof(Actor_TransferRequest))]
	[BsonKnownTypes(typeof(Actor_TestRequest))]
	[BsonKnownTypes(typeof(Actor_TransferRequest))]
	public partial class  AActorRequest {}

	[ProtoInclude(Opcode.Actor_TestResponse, typeof(Actor_TestResponse))]
	[ProtoInclude(Opcode.Actor_TransferResponse, typeof(Actor_TransferResponse))]
	...
	[ProtoInclude(Opcode.C2R_Login, typeof(C2R_Login))]
	[ProtoInclude(Opcode.C2G_LoginGate, typeof(C2G_LoginGate))]
	[ProtoInclude(Opcode.C2G_EnterMap, typeof(C2G_EnterMap))]
	[ProtoInclude(Opcode.C2M_Reload, typeof(C2M_Reload))]
	[ProtoInclude(Opcode.C2R_Ping, typeof(C2R_Ping))]
	...
	[ProtoInclude(Opcode.R2C_Login, typeof(R2C_Login))]
	[ProtoInclude(Opcode.G2C_LoginGate, typeof(G2C_LoginGate))]
	[ProtoInclude(Opcode.G2C_EnterMap, typeof(G2C_EnterMap))]
	[ProtoInclude(Opcode.M2C_Reload, typeof(M2C_Reload))]
	[ProtoInclude(Opcode.R2C_Ping, typeof(R2C_Ping))]
