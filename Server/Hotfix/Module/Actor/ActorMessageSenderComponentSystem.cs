...
namespace ETHotfix
{
    ...
    public class ActorMessageSenderComponentSystem : StartSystem<ActorMessageSenderComponent>
    {
        ...
        {
            List<long> timeoutGateSessionActorIdIds = new List<long>();
            ...
            while (true)
            {
                ...
                timeoutGateSessionActorIdIds.Clear();
                ...
                foreach (long id in self.ActorMessageSenders.Keys)
                {
                    ...
                    timeoutGateSessionActorIdIds.Add(id);
                }

                foreach (long id in timeoutGateSessionActorIdIds)
                {
                    self.Remove(id);
                }
            }
